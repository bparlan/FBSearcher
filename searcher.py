...
for grup in gruplar:
    for urun in urunler:
        url = 'https://www.facebook.com/groups/'+grup+'/for_sale_search/?forsalesearchtype=for_sale&availability=available&query='+urun
        webbrowser.open(url)
